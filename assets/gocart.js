        ...
        var h = function() {
            function GoCart(t) {
                ...
                this.defaults = Object.assign({}, {
                    progressBar: ".go-cart-drawer-progress-bar",
            ...
            return t = GoCart, r = [{
                ...
                key: "cartItemCount",
                value: function(t) {
                    if ( t.item_count < 2 ) {this.cartCount.innerHTML = t.item_count+' item'} else {this.cartCount.innerHTML = t.item_count+' items'}
                }
            }, {
                ...
                value: function(t) {
                    ...
                    this.fetchCart((function() {
                        e.isDrawerMode ? e.openCartDrawer() : e.openMiniCart(), e.openCartOverlay()
                    }))
                }
            }, {
                ...
                value: function(t) {
                    ...
                    this.clearCartDrawer(), t.items.forEach((function(t, r) {
                        ...
                        if ( t.id == 39572397719600 || t.id == 39570793824304 || t.id == 39570793857072 || t.id == 39602407997488) {total_price = Number(total_price+t.line_price)} else {total_price = Number(total_price+t.line_price*discount)}
                        if ( t.id == 39572397719600 || t.id == 39570793824304 || t.id == 39570793857072 || t.id == 39602407997488) { var el_quan = '';} else {var el_quan = '<span class="go-cart-item__quantity-button js-go-cart-quantity-minus">-</span>\n                        <input class="go-cart-item__quantity-number js-go-cart-quantity" type="number" value="'.concat(quan, '" disabled>\n                        <span class="go-cart-item__quantity-button js-go-cart-quantity-plus">+</span>');}
                        if (discount != 1 ) {
                            var o = '\n        <div class="go-cart-item__single" data-line="'.concat(Number(r + 1), '">\n            <div class="go-cart-item__info-wrapper">\n                <div class="go-cart-item__image" style="background-image: url(').concat(t.image, ');"></div>\n                <div class="go-cart-item__info">\n                    <a href="').concat(t.url, '" class="go-cart-item__title">').concat(t.product_title, '</a>\n                    <div class="go-cart-item__variant">').concat(a, '</div>\n                    <div class="go-cart-item__quantity">\n                        ').concat(el_quan,'\n                    </div>\n                </div>\n            </div>\n           <div style="text-decoration: line-through; color:#a6a6a6; padding-right: 3px;position: absolute;bottom: 30px;right: 60px;">').concat(formatMoney(Number(t.line_price), e.moneyFormat), '</div><div class="go-cart-item__price" style="color:red;">').concat(formatMoney(Number(t.line_price*discount), e.moneyFormat), '</div>\n            <a class="go-cart-item__remove ').concat(e.removeFromCartNoDot, '">&#10006</a>\n        </div>\n      ');
                        }else{
                            var o = '\n        <div class="go-cart-item__single" data-line="'.concat(Number(r + 1), '">\n            <div class="go-cart-item__info-wrapper">\n                <div class="go-cart-item__image" style="background-image: url(').concat(t.image, ');"></div>\n                <div class="go-cart-item__info">\n                    <a href="').concat(t.url, '" class="go-cart-item__title">').concat(t.product_title, '</a>\n                    <div class="go-cart-item__variant">').concat(a, '</div>\n                    <div class="go-cart-item__quantity">\n                        ').concat(el_quan,'\n                    </div>\n                </div>\n            </div>\n            <div class="go-cart-item__price">').concat(formatMoney(Number(t.line_price*discount), e.moneyFormat), '</div>\n            <a class="go-cart-item__remove ').concat(e.removeFromCartNoDot, '">&#10006</a>\n        </div>\n      ');
                        }
                        e.cartDrawerContent.innerHTML += o
                    })), this.cartDrawerSubTotal.innerHTML = formatMoney(total_price, this.moneyFormat), this.discuont_calc.innerHTML = formatMoney(total_price, this.moneyFormat), this.cartDrawerSubTotal.parentNode.classList.remove("is-invisible"), document.querySelectorAll(this.removeFromCart).forEach((function(t) {
