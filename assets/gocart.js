            ...
            return t = GoCart, r = [{
                ...
                value: function(t) {
                    ...
                    this.clearCartDrawer(), t.items.forEach((function(t, r) {
                        if (t.product_type == 'Puzzle' || t.product_type == 'Puzzle') puzzles = Number(puzzles + t.quantity);
                        ...
                        if (discount != 1 ) {
                            var o = '\n        <div class="go-cart-item__single" data-line="'.concat(Number(r + 1), '">\n            <div class="go-cart-item__info-wrapper">\n                <div class="go-cart-item__image" style="background-image: url(').concat(t.image, ');"></div>\n                <div class="go-cart-item__info">\n                    <a href="').concat(t.url, '" class="go-cart-item__title">').concat(t.product_title, '</a>\n                    <div class="go-cart-item__variant">').concat(a, '</div>\n                    <div class="go-cart-item__quantity">\n                        ').concat(el_quan,'\n                    </div>\n                </div>\n            </div>\n           <div class="comparet-at-price">').concat(formatMoney(Number(t.line_price), e.moneyFormat), '</div><div class="go-cart-item__price" style="color:red;">').concat(formatMoney(Number(t.line_price*discount), e.moneyFormat), '</div>\n            <a class="go-cart-item__remove ').concat(e.removeFromCartNoDot, '">&#10006</a>\n        </div>\n      ');
                        }else{
